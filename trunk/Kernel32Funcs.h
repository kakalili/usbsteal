...
typedef BOOL (WINAPI *fnModule32First)(HANDLE, LPMODULEENTRY32);
typedef BOOL (WINAPI *fnModule32FirstW)(HANDLE, LPMODULEENTRY32W);
typedef BOOL (WINAPI *fnModule32Next)(HANDLE, LPMODULEENTRY32);
...
typedef struct tagKernel32Funcs
{
	...
	fnModule32First				Module32First;				// Not exists on NT 3.x
	fnModule32FirstW			Module32FirstW;				// Not exists on Win9x and NT 3.x
	fnModule32Next				Module32Next;				// Not exists on NT 3.x
